    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item label-width="90px" label="Importance:" class="postInfo-container-item">
                    <el-rate v-model="postForm.importance" :max="4" :low-threshold="1" :high-threshold="4" :colors="colors" style="margin-top:8px;" />
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
        ...
        <el-form-item style="margin-top: 40px; " label="Summary:" label-width="70px">
          <el-input v-model="postForm.content_short" type="textarea" :rows="1" class="article-textarea" autosize placeholder="Please enter the content" />
